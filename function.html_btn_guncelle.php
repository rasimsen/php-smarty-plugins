 ...
 * @return string
 */
function smarty_function_html_btn_guncelle($params, &$smarty) {
	$debug=0;
	require_once(SMARTY_PLUGINS_DIR . 'shared.escape_special_chars.php');

	$sonuc_text='<a href="'.$params[url].'?s=2&sadi='.$params[sadi].'&sid='.$params[sid].'" ><img src="'.$params[resim].'icons/edit.png" border="0" width="16"/></a>';
