 ...
 * @return string
 */
function smarty_function_html_btn_resim($params, &$smarty) {
	$debug=0;
	require_once(SMARTY_PLUGINS_DIR . 'shared.escape_special_chars.php');

	$sonuc_text='<a href="'.$params[url].'&sadi='.$params[sadi].'&sid='.$params[sid].'" title="'.$params[title].'"><img src="'.$params[resim].'" border="0" width="16"/></a>';
